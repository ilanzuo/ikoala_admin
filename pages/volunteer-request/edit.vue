<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="update_time" label="创建时间">
      ...
      <uni-forms-item name="userId" label="申请人">
        <uni-easyinput placeholder="申请人" v-model="formData.userId"></uni-easyinput>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/volunteer-request.js';

  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'volunteer-request';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("state,update_time,create_time,userId").get().then((res) => {
